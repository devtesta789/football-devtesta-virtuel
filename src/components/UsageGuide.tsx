    ...
    >
      ...
      >
        ...
        <div className="space-y-3 font-mono text-[12px] leading-relaxed text-foreground">
          ...
          <p>{t("guide.step3")}</p>
          <p>{t("guide.step4")}</p>
          <p className="border-l-2 border-cyan pl-2 text-muted-foreground">{t("guide.note")}</p>
          <p className="border border-warn/40 bg-warn/10 p-2 text-warn">⚠ {t("guide.warning")}</p>
