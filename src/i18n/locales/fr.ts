...
export const fr: Translations = {
  ...
  login: {
    ...
    signupSuccess: "Compte créé. Bienvenue !",
  ...
  sync: {
    ...
    autoModeOn: "Mode auto ACTIF",
    autoModeOff: "Activer auto-scan & validation",
    seasonEnded: "Saison terminée ! Changez l'eventCategoryId pour la nouvelle saison.",
    checkDashboard: "Consultez le dashboard IA pour voir l'impact sur les poids",
  },
  guide: {
  ...
  ai: {
    ...
    resetAdvice: "Après le reset, relancez l'entraînement IA sur tous les rounds joués.",
    resetReminder: "N'oubliez pas de relancer 🧠 Train après un reset !",
    confirm: "Confirmer",
    cancel: "Annuler",
    resetDone: "Poids réinitialisés",
    weightsStuck: "Poids IA bloqués aux limites — un reset est recommandé",
    resetNow: "Réinitialiser",
    ...
    recDrawsGood: "Bonne précision sur les nuls — continuez l'entraînement.",
    recLambdaMax: "lambda_boost au plafond — réinitialisez les poids.",
    recHomeAdvMin: "home_advantage au plancher — avantage domicile neutralisé.",
    recWeightsStuck: "Poids bloqués aux limites — réinitialisez et réentraînez.",
